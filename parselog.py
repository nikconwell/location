...
def extract_reason(log_reason):
    ...
    patterns_list = [
        ...
        {'pattern': r'\s*(911 HANG UP).*', 'replacement': r'\1'},
        {'pattern': r'\s*(ASSIST OTHER AGENCY).*', 'replacement': r'\1'},
        {'pattern': r'\s*(brush fire).*', 'replacement': r'\1'},
        {'pattern': r'\s*(DISTURBANCE).*', 'replacement': r'\1'},
        {'pattern': r'\s*(FOUND/\s*LOST PROPERTY).*', 'replacement': r'\1'},
        {'pattern': r'\s*(MISSING/LOST CHILD).*', 'replacement': r'\1'},
        {'pattern': r'\s*(Structure Fire).*', 'replacement': r'\1'},
        {'pattern': r'\s*(Investigation).*', 'replacement': r'\1'},
        ...
        {'pattern': r'\s*vehicle towed\s*', 'replacement': ''},
        {'pattern': r'\s*taken/refer.*', 'replacement': ''},
        {'pattern': r'\s*transport.*', 'replacement': ''},
        ...
        {'pattern': r'\s*arrest.*made', 'replacement': ''},
        {'pattern': r'\s*Civil Matter.*', 'replacement': ''},
        {'pattern': r'\s*gone\s+on\s+arrival\s*', 'replacement': ''},
        {'pattern': r'\s*removed\s*hazard\s*', 'replacement': ''},
        {'pattern': r'\s*extinguished.*', 'replacement': ''},
        {'pattern': r'\s*protective\s*custody', 'replacement': ''},
        {'pattern': r'\s*unable to locate\s*', 'replacement': ''},
        {'pattern': r'\s*unable to serve\s*', 'replacement': ''},
        {'pattern': r'\s*served in-hand.*', 'replacement': ''},
        {'pattern': r'\s*civil matter.*', 'replacement': ''},
        {'pattern': r'\s*merge:.*', 'replacement': ''},
        {'pattern': r'\s*unfounded.*', 'replacement': ''},
        {'pattern': r'\s*unavailable.*', 'replacement': ''},
        {'pattern': r'\s*False\s*alarm.*', 'replacement': ''},
        {'pattern': r'\s*no patient.*', 'replacement': ''},
        {'pattern': r'\s+P\s+-\s*', 'replacement': ''},
        {'pattern': r'\s*F\s*-Cancel.*', 'replacement': ''},
